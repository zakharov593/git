...
{ 
    ...
    { 
        ...
        [HttpDelete]
        [Route("/SmartBear-CC/Task_SwagerHub/1.0.0/store/order/{orderId}")]
        [ValidateModelState]
        ...
        [HttpGet]
        [Route("/SmartBear-CC/Task_SwagerHub/1.0.0/store/inventory")]
        ...
        [HttpPost]
        [Route("/SmartBear-CC/Task_SwagerHub/1.0.0/store/order")]
        [ValidateModelState]
